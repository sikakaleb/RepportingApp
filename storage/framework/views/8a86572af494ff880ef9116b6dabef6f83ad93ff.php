          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form class="pt-3">
                ...
                <div class="my-3">
                  <input type='submit' class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="<?php echo e(route('index')); ?>" value='LOGIN'/>
                </div>
...
<?php /**PATH C:\laragon\www\reportingApp\resources\views/login.blade.php ENDPATH**/ ?>