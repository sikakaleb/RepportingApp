...
<body>
    <div class="container-scroller">
        ...
        <?php echo $__env->make('utilisateur.partials._navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- partial -->
        <div class="container-fluid page-body-wrapper">
                <!-- partial:partials/_sidebar.html -->
                <?php echo $__env->make('utilisateur.partials._sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!-- partial -->
                <div class="main-panel">
                    ...
                    <?php echo $__env->make('utilisateur.partials._footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!-- partial -->
              </div>
        <!-- main-panel ends -->
        </div>
...
<?php /**PATH C:\laragon\www\reportingApp\resources\views/utilisateur/layouts/dashboard.blade.php ENDPATH**/ ?>